...
if not st.session_state.login:
    ...
    try:
        ...
        s1v = "Rs." + str(round(_disb_total / 10000000, 1)) + "Cr"
        s1l = str(_latest) + " Disbursed"
        s2v = str(round((_rev_total / _disb_total * 100) if _disb_total else 0, 1)) + "%"
        s2l = "Avg Payout"
    except Exception:
        s1v, s1l, s2v, s2l = "PrimePL", "Dashboard", "Live", "Analytics"
    ...
    st.markdown(
        ...
        "[data-testid='stAppViewContainer']>.main>.block-container{"
        "padding:3rem 1rem 2rem!important;max-width:500px!important;margin:0 auto!important;}"
        ...
        "color:#f1f5f9!important;font-size:14px!important;padding:11px 14px!important;}"
        ...
        ".stTextInput label{color:#a5b4fc!important;font-size:11px!important;"
    ...
    st.markdown(
        ...
        "font-size:24px;box-shadow:0 8px 24px rgba(99,102,241,0.4);margin-bottom:10px;'>"
        "&#x1F4BC;</div>"
        "<div style='font-size:20px;font-weight:700;color:#fff;margin-bottom:3px;'>Prime PL Dashboard</div>"
        "<div style='font-size:12px;color:#7c8cba;'>MyMoneyMantra &nbsp;&middot;&nbsp; Real-time Analytics</div>"
        "</div>",
        unsafe_allow_html=True
    )
    ...
    chart_svg = (
        ...
        "<rect x='5'  y='60' width='32' height='33' rx='4' fill='#3730a3' opacity='0.85'/>"
        "<rect x='55' y='48' width='32' height='45' rx='4' fill='#4338ca' opacity='0.9'/>"
        "<rect x='105' y='34' width='32' height='59' rx='4' fill='#4f46e5' opacity='0.9'/>"
        "<rect x='155' y='20' width='32' height='73' rx='4' fill='#6366f1' opacity='0.9'/>"
        "<rect x='205' y='8'  width='32' height='85' rx='4' fill='#818cf8' opacity='0.9'/>"
        "<rect x='255' y='1'  width='32' height='92' rx='4' fill='#a5b4fc' opacity='0.9'/>"
        "<polyline points='21,60 71,48 121,34 171,20 221,8 271,1'"
        " fill='none' stroke='#fbbf24' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'/>"
        "<circle cx='21'  cy='60' r='4' fill='#fbbf24'/>"
        "<circle cx='71'  cy='48' r='4' fill='#fbbf24'/>"
        "<circle cx='121' cy='34' r='4' fill='#fbbf24'/>"
        "<circle cx='171' cy='20' r='4' fill='#fbbf24'/>"
        "<circle cx='221' cy='8'  r='4' fill='#fbbf24'/>"
        "<circle cx='271' cy='1'  r='4' fill='#fbbf24'/>"
        "<text x='21'  y='90' fill='#818cf8' font-size='8' text-anchor='middle' font-family='Inter,sans-serif'>Nov</text>"
        "<text x='71'  y='90' fill='#818cf8' font-size='8' text-anchor='middle' font-family='Inter,sans-serif'>Dec</text>"
        "<text x='121' y='90' fill='#818cf8' font-size='8' text-anchor='middle' font-family='Inter,sans-serif'>Jan</text>"
        "<text x='171' y='90' fill='#818cf8' font-size='8' text-anchor='middle' font-family='Inter,sans-serif'>Feb</text>"
        "<text x='221' y='90' fill='#818cf8' font-size='8' text-anchor='middle' font-family='Inter,sans-serif'>Mar</text>"
        "<text x='271' y='90' fill='#818cf8' font-size='8' text-anchor='middle' font-family='Inter,sans-serif'>Apr</text>"
        "</svg>"
    )

    ps = (
        "flex:1;background:rgba(99,102,241,0.18);"
    ...
    st.markdown(
        ...
        "border-radius:18px;padding:20px 20px 16px;margin-bottom:12px;'>"
        + chart_svg +
        "<div style='display:flex;gap:8px;margin-top:14px;'>"
        "<div style='" + ps + "'>"
        "<div style='font-size:15px;font-weight:700;color:#fff;'>" + s1v + "</div>"
        "<div style='font-size:10px;color:#a5b4fc;margin-top:2px;'>" + s1l + "</div>"
        "</div>"
        "<div style='" + ps + "'>"
        "<div style='font-size:15px;font-weight:700;color:#fff;'>" + s2v + "</div>"
        "<div style='font-size:10px;color:#a5b4fc;margin-top:2px;'>" + s2l + "</div>"
        "</div>"
        "<div style='" + ps + "'>"
        "<div style='font-size:15px;font-weight:700;color:#fff;'>" + today_str + "</div>"
        "<div style='font-size:10px;color:#a5b4fc;margin-top:2px;'>Today IST</div>"
        "</div>"
        "</div></div>",
        unsafe_allow_html=True
    )

    # Login card — same border-radius, same width as chart card
    st.markdown(
        "<div style='background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);"
        "border-radius:18px;padding:22px 22px 8px;'>"
        "<div style='font-size:17px;font-weight:700;color:#fff;margin-bottom:2px;'>Welcome back &#x1F44B;</div>"
        "<div style='font-size:12px;color:#64748b;margin-bottom:2px;'>Sign in to continue</div>"
        "</div>",
        unsafe_allow_html=True
    )
    ...
    if st.button("Sign in  \u2192", use_container_width=True, key="login_btn"):
        if u == USERNAME and p == PASSWORD:
            ...
            if left_att <= 0:
                ...
                st.error("\U0001F512 Too many attempts. Account locked for 12 hours.")
            else:
