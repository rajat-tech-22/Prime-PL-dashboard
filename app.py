...
if dashboard_type=="Single Manager":
    ...
    if filtered_df.empty:
        ...
        st.plotly_chart(plot_bar(filtered_df,"Bank",top_bank,selected_manager,key_val="bank1"), use_container_width=True)
        st.plotly_chart(plot_bar(filtered_df,"Caller",top_caller,selected_manager,key_val="caller1"), use_container_width=True)
...
if dashboard_type=="Comparison":
    ...
    filtered_df = filter_df(df)
    st.warning("Comparison dashboard works only for multi-managers selection.")
