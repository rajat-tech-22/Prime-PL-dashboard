...
# CSV LINKS
# -----------------------------
DATA_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRfDuP8FJ8yxoZxPPiKYrxWyP1Brlq7hmyxrkp81_oURiPrCJHqup7Ru8wFoE-pWMEZjZIuH_VBM5_i/pub?output=csv"
TARGET_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTplHDYVsgbTHNJsFFqLBzbRc4Gj8RYlrjRs4H8NxRy2V7iAFl0-teSToWaSHz5BReD5rSsgVv1sjMs/pub?gid=0&single=true&output=csv"
...
def load_data():
    df_main = pd.read_csv(DATA_CSV_URL)
    ...
    # Merge main + target on Manager + Month
    df = df_main.merge(df_target, left_on=["Manager","Disb Month"], right_on=["Manager","Month"], how="left")
